...
Escape hatches (`HARNESS_SF_SKIP_*=1`) exist for emergency overrides — preserve them for new gates so users can unblock themselves without uninstalling.
